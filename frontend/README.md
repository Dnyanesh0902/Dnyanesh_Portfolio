...
3. **Secure Administrative Workspace**:
   ...
   - **Five-Tab Navigation Panel**: Handles inquiries review, project editing, skill configurations, experience entries, and **Settings & CV (co-admin registration, database-persistent resume PDF uploads)** in dedicated screens.
